...
[`verl_generation_prompt_probe.py`](https://github.com/ruiling-smartbear/sglang-omni/blob/bench/975/verl_generation_prompt_probe.py),
[`verl_template_snippets.py`](https://github.com/ruiling-smartbear/sglang-omni/blob/bench/975/verl_template_snippets.py),
[`verl_gptoss_detail.py`](https://github.com/ruiling-smartbear/sglang-omni/blob/bench/975/verl_gptoss_detail.py).
